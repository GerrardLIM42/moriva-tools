...
window.MORIVA_TOOLS = [
  {
    ...
    items: [
      ...
      { id: "opportunity-finder",     icon: "🎯", name: "기회 발굴",          desc: "아이템스카우트 아이템발굴+3년 추세+1688 원가+쿠팡 수요/가격으로 저경쟁 고마진 상품을 자동으로 찾습니다.", badge: "NEW" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "seedance-prompt-generator", icon: "🎥", name: "Seedance 광고 프롬프트 생성기", desc: "제품 이미지를 분석해 Seedance 2.5용 영상 광고 프롬프트를 자동으로 만듭니다 (AI 서비스 설정에서 선택한 AI 사용, 독립형).", badge: "NEW" },
      { id: "seedance-shopping-shorts", icon: "🛍️", name: "Seedance 쇼핑쇼츠 프롬프트 생성기", desc: "제품 이미지·실사용 영상·벤치마킹 쇼츠를 참고해 20초 쇼핑쇼츠 프롬프트를 만들고, 생성 결과 영상 수정 프롬프트까지 만들어주는 독립형 도구.", badge: "NEW" },
